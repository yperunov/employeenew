...
import dev.ji.employeenew.exception.EmployeeArrayFullException;
import dev.ji.employeenew.exception.EmployeeHasAlreadyAddedException;
import dev.ji.employeenew.exception.EmployeeNotFoundException;
...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    private int arrayCapacity = 5;//емкость массива сотрудников
